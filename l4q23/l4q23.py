...
for linha in dados_de_usuario:
    # strip retorna uma string e capitalize coloca a 1 letra em Maiúsculo
    l_nomes.append(linha[:16].strip().capitalize())
...
for i in range(len(l_nomes)):
    ...
    '''o sinal de ">" coloca o texto alinhado à direita'''
